...
export const TABLE_OF_SURVEY_ENTRIES: TableOfSurveyEntry[] = [
  { surveyFocus: "Arrival/Administration", surveyType: "arrival", spaceType: "Main Office", spaceTypeRaw: "Main Entry/Reception", schoolLevel: "ES", required: true, scoringFocusLabel: "Arrival/Administration", scoringFocusAreaId: "arrival_administration", spaceTypeWeight: 12, focusAreaWeight: 6, scoreCode: "ME" },
  ...
  { surveyFocus: "Arrival/Administration", surveyType: "arrival", spaceType: "Main Office", spaceTypeRaw: "Main Entry/Reception", schoolLevel: "MS", required: true, scoringFocusLabel: "Arrival/Administration", scoringFocusAreaId: "arrival_administration", spaceTypeWeight: 12, focusAreaWeight: 6, scoreCode: "ME" },
  ...
  { surveyFocus: "Arrival/Administration", surveyType: "arrival", spaceType: "Main Office", spaceTypeRaw: "Main Entry/Reception", schoolLevel: "HS", required: true, scoringFocusLabel: "Arrival/Administration", scoringFocusAreaId: "arrival_administration", spaceTypeWeight: 12, focusAreaWeight: 6, scoreCode: "ME" },
