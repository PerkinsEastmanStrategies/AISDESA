...
export default function ScoreWalkthrough({
  ...
  }, [session, state.roomScoreDetails, state.surveyType, roomIds, state.school?.schoolClass])
  ...
  }, [focus, campus, details, session, state.surveyType, state.allRooms, focusRoomId, state.school?.schoolClass])
