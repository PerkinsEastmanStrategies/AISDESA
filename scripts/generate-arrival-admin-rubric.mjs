...
const csvDir = path.join(workspaceRoot, "packages", "shared", "src", "data", "arrival-admin-survey")
...
`
  ...
  for (const c of categories) {
    out += `  { assessmentArea: ${esc(pkg.assessmentArea)}, category: ${esc(c.CategoryName)}, categoryWeight: ${Number(c.CategoryWeight)} },\n`
  }
