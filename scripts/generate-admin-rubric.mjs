...
const csvDir = path.join(workspaceRoot, "packages", "shared", "src", "data", "admin-survey")
...
const ASSESSMENT_AREA = "Administration"

const PACKAGES = [
  {
    spaceTypeId: "SPT-ADMIN-OFFICE",
...
`
  ...
  for (const q of questions) {
    ...
    const grade = String(q.GradeApplicability ?? "").trim()
